...
class makeMember {
    ...
    private function __construct() {
     ...
     $this->define( 'MAKESF_PLUGIN_VERSION', '1.5.3');
  ...
  private function includes() {
    ...
    include_once MAKESF_ABSPATH . 'inc/gf-coupon.class.php';
