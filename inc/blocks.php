...
add_action('acf/init', function () {
	...
	if( function_exists('acf_register_block_type')) :
		...
		acf_register_block_type(array(
			'name'              => 'make-sponsorship-tiers',
			'title'             => __('Sponsorship Tiers'),
			'description'       => __('A block that displays sponsorship tiers in a card layout.'),
			'render_template'   => MAKESF_ABSPATH . '/inc/templates/make-sponsorship-tiers.php',
			'category'          => 'make-blocks',
			'icon'              => MAKE_LOGO,
			'keywords'          => array( 'sponsorship', 'sponsor', 'tiers', 'cards', 'make', 'mind', 'Mindshare'),
			'align'             => 'full',
			'mode'            	=> 'edit',
			'multiple'          => false,
			'supports'					=> array(
...
add_action( 'acf/include_fields', function() {
	...
	acf_add_local_field_group( array(
		'key' => 'group_6838bfc1d8e01',
		'title' => 'BLOCK: Sponsorship Tiers',
		'fields' => array(
			array(
				'key' => 'field_6838bfc1d8e02',
				'label' => 'Sponsorship Tiers',
				'name' => 'make_sponsorship_tiers',
				'aria-label' => '',
				'type' => 'group',
				'instructions' => '',
				'required' => 0,
				...
				'sub_fields' => array(
					array(
						'key' => 'field_6838bfc1d8e03',
						'label' => 'Tier Cards',
						'name' => 'tiers',
						'aria-label' => '',
						'type' => 'repeater',
						'instructions' => 'Add each sponsorship tier as a card.',
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
						...
						'min' => 0,
						'max' => 0,
						'collapsed' => 'field_6838bfc1d8e04',
						'button_label' => 'Add Tier',
						'rows_per_page' => 20,
						'sub_fields' => array(
							array(
								'key' => 'field_6838bfc1d8e04',
								'label' => 'Name',
								'name' => 'name',
								'aria-label' => '',
								'type' => 'text',
								'instructions' => 'Tier name, such as Bronze or Presenting Sponsor.',
								'required' => 1,
								'conditional_logic' => 0,
								'wrapper' => array(
									'width' => '50',
								...
								'prepend' => '',
								'append' => '',
								'parent_repeater' => 'field_6838bfc1d8e03',
							),
							array(
								'key' => 'field_6838bfc1d8e05',
								'label' => 'Level',
								'name' => 'level',
								'aria-label' => '',
								'type' => 'text',
								'instructions' => 'Tier amount or level label.',
								'required' => 0,
								'conditional_logic' => 0,
								'wrapper' => array(
									'width' => '50',
							...
							array(
								'key' => 'field_6838bfc1d8e06',
								'label' => 'Content',
								'name' => 'content',
								'aria-label' => '',
								'type' => 'wysiwyg',
								'instructions' => 'Describe benefits or details for this tier.',
								'required' => 0,
								'conditional_logic' => 0,
								'wrapper' => array(
									'width' => '',
							...
							array(
								'key' => 'field_6839d3f3d8e07',
								'label' => 'Benefits',
								'name' => 'benefits',
								'aria-label' => '',
								'type' => 'repeater',
								'instructions' => 'Add one benefit per line item.',
								'required' => 0,
								'conditional_logic' => 0,
								'wrapper' => array(
									'width' => '70',
								...
								'sub_fields' => array(
									array(
										...
										'default_value' => '',
										'maxlength' => '',
										'placeholder' => 'Logo placement on event signage',
										'prepend' => '',
										'append' => '',
										'parent_repeater' => 'field_6839d3f3d8e07',
									),
								),
							),
							array(
								'key' => 'field_6839d3f3d8e09',
								'label' => 'Featured Tier',
								'name' => 'featured',
								'aria-label' => '',
								'type' => 'true_false',
								'instructions' => 'Turn this on to visually showcase this tier.',
								'required' => 0,
								'conditional_logic' => 0,
								'wrapper' => array(
									'width' => '30',
